        ...
        <div class="mb-4">
            ...
            <div class='row justify-container-center'>
                <div class='col-md-8'>
                    ...
                    <img src=@if(count($item->photos)==0)"{{ asset('storage/default_images/empty_picture.png') }}"@else {{ asset("storage/images/") }}/{{$item->photos[0]->file_patch}} @endif/>
                    <div>{{$item->description}}</div>
            </div>
            <div class='col-md-4 border'>
                <img class="border h-25 mt-3" src=@if($item->user->avatar==null)"{{ asset('storage/default_images/empty_profile.png') }}"@else "{{ asset("storage/avatars/") }}/{{$item->user->avatar}}" @endif/>
                <div class="mt-2 mb-2">
